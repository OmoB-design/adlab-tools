          ...
          <div className="flex flex-col gap-(--space-64)">
                ...
                <div key={i} className="flex flex-1 flex-col gap-(--space-10)">
                  <div
                    className={`h-[5px] w-full rounded-[4px] ${
                      i === 0 ? 'bg-(--color-purple-400)' : 'bg-(--color-surface-fg-01)'
                    }`}
                  />
            ...
            <div className="flex flex-col gap-(--space-40)">
              ...
              <div className="flex flex-col" style={{ gap: '56px' }}>
                ...
                <div
                  className="animate-fade-in-up flex w-full items-center gap-(--space-8) rounded-(--radius-xl) border border-(--color-surface-stroke) bg-(--color-surface-primary) px-[14px] py-(--space-12) shadow-(--shadow-input) transition-[border-color,box-shadow] duration-150 ease-in-out focus-within:border-(--color-purple-400) focus-within:shadow-[0px_0px_0px_2px_rgba(202,93,236,0.15)]"
